      ...
      <main className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            {/* Quick Stats */}
            <div className="bg-white/60 dark:bg-slate-100 dark:bg-gray-800/40 border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 space-y-4">
          ...
          <div className="lg:col-span-8 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-slate-300 dark:border-gray-700/50 rounded-2xl p-6">
                 <div className="text-slate-400 dark:text-gray-500 text-[10px] font-black uppercase mb-1">Total PnL</div>
               ...
               <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-slate-300 dark:border-gray-700/50 rounded-2xl p-6">
                 <div className="text-slate-400 dark:text-gray-500 text-[10px] font-black uppercase mb-1">Copied Traders</div>
               ...
               <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-slate-300 dark:border-gray-700/50 rounded-2xl p-6 relative overflow-hidden">
                 <div className="text-slate-400 dark:text-gray-500 text-[10px] font-black uppercase mb-1">Total Trading Vol.</div>
            ...
            {/* Crypto Portfolio */}
            <div className="bg-white/60 dark:bg-slate-100 dark:bg-gray-800/40 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-8">
            ...
            <div className="bg-white/60 dark:bg-slate-100 dark:bg-gray-800/40 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-8">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left">
                  <thead>
                    <tr className="text-slate-400 dark:text-gray-500 text-[10px] font-black uppercase tracking-widest border-b border-slate-300 dark:border-gray-700/50">
                  ...
                  <tbody className="divide-y divide-gray-700/30">
                    {transactions.length === 0 ? (
                      ...
                      transactions.map((tx) => (
                        <tr key={tx.id} className="text-sm border-b border-slate-300 dark:border-gray-700/20 group hover:bg-white/5 transition-colors">
                          <td className="py-4">
                          ...
                          <td className="py-4 font-medium italic text-slate-500 dark:text-gray-400">{tx.status}</td>
