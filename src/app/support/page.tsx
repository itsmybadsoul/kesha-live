  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] flex flex-col items-center justify-center p-6 bg-[url(https://www.transparenttextures.com/patterns/carbon-fibre.png)]">
      ...
      <div className="max-w-md w-full bg-white/70 dark:bg-gray-900/40 dark:bg-gray-800/50 backdrop-blur-2xl border border-slate-300 dark:border-gray-700/50 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
        ...
        <h1 className="text-3xl font-black text-center mb-2 text-slate-900 dark:text-white">Secure Support Node</h1>
        <p className="text-slate-500 dark:text-gray-400 text-center text-sm mb-8 font-medium">Transmit an encrypted message directly to our institutional administration desk.</p>

        <form onSubmit={handleSubmit} className="space-y-5">
           <div className="relative group/input">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Mail className="w-5 h-5 text-slate-400 dark:text-gray-500 group-focus-within/input:text-indigo-400 transition-colors" />
              </div>
              <input
                type="email"
                value={email}
           ...
           <div className="relative group/input">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <ShieldCheck className="w-5 h-5 text-slate-400 dark:text-gray-500 group-focus-within/input:text-indigo-400 transition-colors" />
              </div>
              <input
                type="text"
                value={subject}
           ...
           <div className="relative group/input border border-slate-300 dark:border-gray-700 rounded-2xl bg-white/80 dark:bg-gray-900/50 focus-within:border-indigo-500 overflow-hidden">
               <textarea
                 ...
                 disabled={loading}
                 className="block w-full p-4 min-h-[120px] bg-transparent outline-none transition-all placeholder:text-gray-600 text-sm text-slate-900 dark:text-white resize-none"
                 required
               />
           </div>
           ...
           <button
             type="submit"
             disabled={loading}
             className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-slate-900 dark:text-white font-black uppercase tracking-widest text-xs py-4 rounded-2xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95 flex items-center justify-center gap-2"
           >
