    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] text-slate-900 dark:text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-black text-slate-900 dark:text-white mb-3">Terms of Use</h1>
          <p className="text-slate-400 dark:text-gray-500 text-sm">Last updated: March 21, 2026</p>
        </div>
 
        <div className="prose prose-invert max-w-none space-y-8 text-slate-600 dark:text-gray-300 text-sm leading-relaxed">
 
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">3. Account Registration</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">4. Investment Risk Disclosure</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">5. Prohibited Activities</h2>
            <p>You agree not to use the Platform to:</p>
            <ul className="list-disc list-inside space-y-1 text-slate-500 dark:text-gray-400 mt-2">
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">6. Deposits & Withdrawals</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">7. KYC / AML Policy</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">9. Modifications</h2>
      ...
      <footer className="border-t border-slate-200 dark:border-gray-800 py-6 mt-8">
