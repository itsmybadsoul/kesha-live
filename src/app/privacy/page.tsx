    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] text-slate-900 dark:text-white">
      ...
      <main className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert max-w-none space-y-8 text-slate-600 dark:text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">2. How We Use Your Information</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">3. Data Storage & Security</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">4. KYC Document Retention</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">5. Sharing of Information</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">6. Cookies & Tracking</h2>
          ...
          <section>
            <h2 className="text-lg font-black text-slate-900 dark:text-white mb-3">8. Changes to This Policy</h2>
