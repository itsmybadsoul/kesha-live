  ...
  return (
    <div className="bg-gradient-to-br from-indigo-900/40 to-gray-800/40 backdrop-blur-xl border border-indigo-500/20 rounded-3xl p-6 relative overflow-hidden group">
      ...
      <div className="flex gap-3 relative z-10">
         ...
         <button className="bg-slate-100 dark:bg-gray-800/80 hover:bg-gray-700 text-slate-900 dark:text-white font-black px-6 rounded-2xl transition-all border border-slate-300 dark:border-gray-700 active:scale-95">
