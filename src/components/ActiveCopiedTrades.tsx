  ...
  if (activeTrades.length === 0) {
    return (
      <div className="bg-slate-100 dark:bg-gray-800/80 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 lg:p-8 text-center py-12">
        ...
        <p className="text-sm text-slate-500 dark:text-gray-400 px-8">Find elite traders in the social leaderboard and start copying their moves automatically.</p>
      </div>
    );
  }
    ...
    <div className="bg-slate-100 dark:bg-gray-800/80 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 lg:p-8">
      ...
      <div className="space-y-3">
        {activeTrades.map((trade) => {
          ...
          return (
            <div key={trade.id} className="relative bg-gradient-to-r from-gray-900/80 to-gray-800 border border-slate-300 dark:border-gray-700/50 rounded-xl p-5 hover:border-gray-600 transition-colors group overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="text-slate-900 dark:text-white font-bold text-sm">{trade.pair}</span>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4 text-xs font-medium pt-3 border-t border-slate-300 dark:border-gray-700/50">
                <div className="text-slate-500 dark:text-gray-400 space-y-1">
                  <div className="flex justify-between"><span>Entry:</span> <span className="text-slate-600 dark:text-gray-300">${trade.entry.toLocaleString()}</span></div>
                ...
                <div className="text-right flex flex-col justify-center">
                  <div className="text-[10px] text-slate-400 dark:text-gray-500 font-bold uppercase">Estimated PnL</div>
                  <div className="text-sm font-black text-slate-500 dark:text-gray-400 italic">Calculating...</div>
                </div>
              </div>
              
              <div className="mt-4 text-[9px] text-gray-600 uppercase font-black tracking-widest text-center border-t border-slate-300 dark:border-gray-700/30 pt-2 italic">
