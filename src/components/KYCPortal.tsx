    ...
    <div className="bg-white/60 dark:bg-slate-100 dark:bg-gray-800/40 backdrop-blur-2xl border border-slate-300 dark:border-gray-700/50 rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl">
      ...
      {step === 2 && (
        <div className="space-y-4 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="border border-dashed border-gray-600 bg-white dark:bg-gray-900/30 rounded-3xl p-12 text-center hover:border-indigo-500 hover:bg-indigo-500/5 transition-all duration-300 cursor-pointer group shadow-inner" onClick={() => selfieInputRef.current?.click()}>
            ...
            <p className="text-sm text-slate-400 dark:text-gray-500 max-w-md mx-auto">Take a real-time selfie to cryptographically match your uploaded identification document.</p>
          </div>
        </div>
      )}
      ...
      {step === 3 && (
        <div className="space-y-6 text-center py-8 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <p className="text-slate-500 dark:text-gray-400 mb-8 max-w-md mx-auto">Your biometric materials have been hashed and are ready for secure transmission to the compliance oracle.</p>
          
          <div className="flex gap-6 justify-center mb-10">
            {idFront && <img src={idFront} className="h-20 w-auto rounded-lg border border-slate-300 dark:border-gray-700 opacity-50 shadow-lg" />}
            {idBack && <img src={idBack} className="h-20 w-auto rounded-lg border border-slate-300 dark:border-gray-700 opacity-50 shadow-lg" />}
          </div>
