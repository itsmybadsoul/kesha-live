...
export function SwapTrade() {
  ...
  return (
    <div className="bg-slate-100 dark:bg-gray-800/80 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 lg:p-8 shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-gray-400 mt-1">Zero-fee swaps at real-time market rates.</p>
        </div>
        ...
        <div className="bg-white dark:bg-white dark:bg-gray-900/80 border border-slate-200 dark:border-gray-800 rounded-2xl p-4 transition-all focus-within:border-indigo-500/50">
           ...
           <div className="flex items-center gap-4">
              ...
              <select 
                ...
                className="bg-slate-100 dark:bg-gray-800 border border-slate-300 dark:border-gray-700 rounded-xl px-3 py-2 text-sm font-bold text-slate-900 dark:text-white outline-none cursor-pointer"
              >
      ...
      <div className="mt-8 space-y-4">
         ...
         <button 
           ...
           className="w-full bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 text-slate-900 dark:text-white font-black py-4 rounded-2xl transition-all shadow-xl shadow-indigo-500/20 flex items-center justify-center gap-2 group active:scale-[0.98] uppercase tracking-widest text-xs"
         >
         ...
         <div className="flex gap-2 p-3 bg-indigo-500/5 border border-indigo-500/10 rounded-xl">
            ...
            <p className="text-[9px] text-slate-400 dark:text-gray-500 font-medium leading-relaxed uppercase">
