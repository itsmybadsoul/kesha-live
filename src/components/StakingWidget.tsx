    ...
    <div className="bg-gradient-to-br from-indigo-600/20 to-gray-800/40 backdrop-blur-xl border border-indigo-500/20 rounded-3xl p-6 relative overflow-hidden group">
      ...
      <div className="space-y-4 relative z-10">
        <div className="bg-black/40 p-5 rounded-2xl border border-indigo-500/10">
           ...
           <div className="text-3xl font-black text-slate-900 dark:text-white tracking-tighter tabular-nums flex items-baseline gap-2">
              12.40<span className="text-sm text-slate-400 dark:text-gray-500 font-bold">%</span>
           </div>
           <p className="text-[10px] text-slate-400 dark:text-gray-500 font-medium mt-1">Variable interest paid daily to your account balance.</p>
        </div>
      ...
      <div className="mt-6 pt-6 border-t border-slate-300 dark:border-gray-700/30 flex items-center gap-3">
         <ShieldCheck className="w-5 h-5 text-indigo-400" />
         <div className="text-[9px] text-slate-400 dark:text-gray-500 font-medium leading-relaxed">
