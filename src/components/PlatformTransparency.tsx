  ...
  return (
    <div className="bg-white/60 dark:bg-gray-900/40 dark:bg-gray-800/40 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6">
      ...
      <div className="space-y-6">
        <div className="bg-white dark:bg-gray-900/40 p-5 rounded-2xl border border-slate-300 dark:border-gray-700/30">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white tabular-nums">12.4M USDT</div>
          <div className="text-[10px] text-slate-400 dark:text-gray-500 font-bold mt-1 uppercase tracking-tight">Maintained on-chain liquidity</div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900/40 p-5 rounded-2xl border border-slate-300 dark:border-gray-700/30">
          ...
          <div className="text-2xl font-black text-slate-900 dark:text-white tabular-nums">4.8M USDT</div>
          <div className="text-[10px] text-slate-400 dark:text-gray-500 font-bold mt-1 uppercase tracking-tight">Real-time across all nodes</div>
        </div>
        ...
        <div className="flex items-center gap-4 px-2">
          ...
          <div className="text-[10px] text-slate-400 dark:text-gray-500 font-bold">Secure Global Infrastructure</div>
        </div>
      </div>
