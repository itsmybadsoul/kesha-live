  ...
  return (
    <div className="bg-white/60 dark:bg-slate-100 dark:bg-gray-800/40 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 lg:p-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="text-[10px] text-slate-400 dark:text-gray-500 font-black uppercase tracking-widest bg-white/80 dark:bg-white dark:bg-gray-900/50 px-3 py-1 rounded-full border border-slate-200 dark:border-gray-800">
          Top 10 Assets
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
        {prices.slice(0, 10).map((p) => (
          <div key={p.symbol} className="bg-white/80 dark:bg-white dark:bg-gray-900/50 border border-slate-200 dark:border-gray-800 hover:border-indigo-500/30 transition-colors rounded-2xl p-4 group">
