...
export function ROICalculator() {
  ...
  return (
    <div className="bg-slate-100 dark:bg-gray-800/80 backdrop-blur-xl border border-slate-300 dark:border-gray-700/50 rounded-3xl p-6 lg:p-8 relative">
      <div className="flex items-center gap-3 mb-8">
        <div className="bg-indigo-500/20 p-3 rounded-xl">
          <Calculator className="w-6 h-6 text-indigo-400" />
        </div>
        <div>
          <h2 className="text-xl font-bold text-slate-900 dark:text-white">Dream ROI Calculator</h2>
          <p className="text-sm text-slate-500 dark:text-gray-400">See your potential daily earnings in real-time.</p>
        </div>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          <div className="flex justify-between items-end mb-4">
            <span className="text-slate-500 dark:text-gray-400 font-medium">If I deposit...</span>
            <div className="flex items-center text-3xl font-bold text-slate-900 dark:text-white">
              <DollarSign className="w-6 h-6 text-slate-400 dark:text-gray-500" />
          ...
          />
          <div className="flex justify-between mt-2 text-xs text-slate-400 dark:text-gray-500 font-medium">
            <span>$100</span>
            <span>$25,000+</span>
          </div>
        </div>
        ...
        <div className="bg-white/90 dark:bg-gray-900/60 rounded-2xl p-6 border border-slate-300 dark:border-gray-700/50 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center mb-6">
            <span className="text-slate-500 dark:text-gray-400">Active Tier:</span>
            <span className={`text-sm font-bold bg-slate-100 dark:bg-gray-800 px-3 py-1 rounded-full border border-slate-300 dark:border-gray-700 ${getTierColor()}`}>
              {getTierName()}
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-xs text-slate-400 dark:text-gray-500 font-medium uppercase tracking-wider mb-1">Daily Profit</p>
              <p className={`text-3xl font-bold ${getTierColor()} transition-colors duration-300`}>
                ${dailyReturn}
              </p>
            </div>
            <div>
              <p className="text-xs text-slate-400 dark:text-gray-500 font-medium uppercase tracking-wider mb-1">Monthly (30D)</p>
